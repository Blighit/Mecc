...
#include "interfaces/action/detail/progress__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // actions, llm_response
#include "rosidl_runtime_c/string_functions.h"  // actions, llm_response

// forward declare type support functions


using _Progress_Goal__ros_msg_type = interfaces__action__Progress_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: llm_response
  {
    const rosidl_runtime_c__String * str = &ros_message->llm_response;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: llm_response
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->llm_response.data) {
      rosidl_runtime_c__String__init(&ros_message->llm_response);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->llm_response,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'llm_response'\n");
      return false;
    }
  }
...
size_t get_serialized_size_interfaces__action__Progress_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->llm_response.size + 1);
...
static uint32_t _Progress_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__action__Progress_Goal;
    is_plain =
      (
      offsetof(DataType, llm_response) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Progress_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Goal)() {
...
using _Progress_Result__ros_msg_type = interfaces__action__Progress_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_Result__ros_msg_type * ros_message = static_cast<const _Progress_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_Result;
    is_plain =
      (
...
static size_t _Progress_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Result)() {
...
using _Progress_Feedback__ros_msg_type = interfaces__action__Progress_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_Feedback__ros_msg_type * ros_message = static_cast<const _Progress_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_Feedback;
    is_plain =
      (
...
static size_t _Progress_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Feedback)() {
...
// already included above
// #include "interfaces/action/detail/progress__functions.h"  // goal
...
using _Progress_SendGoal_Request__ros_msg_type = interfaces__action__Progress_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Progress_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interfaces__action__Progress_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__action__Progress_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_SendGoal_Request;
    is_plain =
      (
...
static size_t _Progress_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_SendGoal_Request)() {
...
using _Progress_SendGoal_Response__ros_msg_type = interfaces__action__Progress_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Progress_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_SendGoal_Response;
    is_plain =
      (
...
static size_t _Progress_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_SendGoal)() {
...
using _Progress_GetResult_Request__ros_msg_type = interfaces__action__Progress_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Progress_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_GetResult_Request;
    is_plain =
      (
...
static size_t _Progress_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_GetResult_Request)() {
...
// already included above
// #include "interfaces/action/detail/progress__functions.h"  // result
...
using _Progress_GetResult_Response__ros_msg_type = interfaces__action__Progress_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Progress_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interfaces__action__Progress_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__action__Progress_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_GetResult_Response;
    is_plain =
      (
...
static size_t _Progress_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_GetResult)() {
...
// already included above
// #include "interfaces/action/detail/progress__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Progress_FeedbackMessage__ros_msg_type = interfaces__action__Progress_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, action, Progress_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__action__Progress_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Progress_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Progress_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interfaces__action__Progress_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__action__Progress_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__action__Progress_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__action__Progress_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces__action__Progress_FeedbackMessage;
    is_plain =
      (
...
static size_t _Progress_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__action__Progress_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, action, Progress_FeedbackMessage)() {
